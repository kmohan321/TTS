...
class Conv_Upsampling(nn.Module):
  def __init__(self,
    ...
    self.output_paddings = [0, 1, 4, 4, 3]
...
if __name__ == "__main__":
    ...
    model = AudioTokenizer(strides = [8,6,4,4], input_channels=1, hidden_channels= 64, latent_channels=512, kernel=7,
                           num_codebook=4,codebook_dim=512,codebook_size=1048)
